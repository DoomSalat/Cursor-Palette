...
- Bundle (.cursorpalette) — vollständige Kopie: alle Rollen, gesperrte Rollen, Cursorgröße und Skalierungsflag bleiben erhalten, und aus anderen Presets geliehene Rollen werden mitkopiert, sodass die Datei in sich geschlossen ist. Gruppen werden ebenfalls gespeichert und beim Import wiederhergestellt. Gedacht zum späteren vollständigen Re-Import in diese App.
- ZIP-Archiv — ein Ordner pro Preset mit den rohen .cur/.ani-Dateien, plus eine cursor-palette.json-Datei mit vollständigen Metadaten (Rollen, gesperrte Rollen, Cursorgröße, Skalierungsflag, Gruppen) und eine README.txt mit Installationsanleitung. Kann wie ein Bundle in diese App re-importiert oder außerhalb davon mit anderen Tools verwendet werden.
