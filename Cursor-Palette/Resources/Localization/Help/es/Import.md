...
ℹ️ Los paquetes y los archivos ZIP restauran todo (roles, roles bloqueados, tamaño del cursor, indicador de escalado, modo de escalado, grupos). Los archivos ZIP también incluyen un README.txt con instrucciones de instalación y carpetas con los archivos de cursor originales.