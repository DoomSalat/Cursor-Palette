...
📦 La flecha "▾" del botón de descarga del editor de preajustes también tiene "Exportación completa (Windows + Linux)" — junta un archivo ZIP con una carpeta para Windows (archivos .cur/.ani originales) y una carpeta para Linux (tema Xcursor) del preajuste que estás editando.
