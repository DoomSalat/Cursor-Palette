...
This window opens after picking a Cursor Palette bundle (.cursorpalette) or ZIP archive — either via the Import button or by dropping the file onto the main window.
